...
{name: "", gender: "", hobbies: "", country: "", address: ""})
    ...
    const getStudents=()=>{
       ServerCall.sendGetReq('std/get',{data:formData})
       .then((res)=>{
    ...
    <div>
        ...
        <div className='container-fluid'>
            ...
            <div className='row mb-4'>
                ...
                <div className='col-sm-3'>
                    <textarea value={formData.address} name='address' onChange={fnChange} className='form-control'></textarea>
                </div>
            </div>
            <div className='row mb-4'>
        ...
        <div className='table-responsive'>
            <table className='table table-bordered table-hover table-stripped'>
               <thead>
                <tr>
                    <th>ID</th><th>NAME</th><th>GENDER</th><th>HOBBIES</th><th>COUNTRY</th>
               ...
               <tbody>
                  {
                    students.map((obj,index)=>{
                        ...
                        return <tr key={index}>
                           ...
                           <td>{hobbies}</td><td>{country}</td><td>{address}</td>
